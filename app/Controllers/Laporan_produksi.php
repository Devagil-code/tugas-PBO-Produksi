...
class Laporan_produksi extends Controller
{
    ...
    public function index()
    {
        ...
        // Mengambil data dari tabel produksi dan detail_produksi
        $builder = $db->table('produksi');
        $builder->select('produksi.id_produksi, produksi.jumlah_produksi, produksi.tanggal_produksi, produk.nama_produk, bahan_baku.nama_bahan_baku');
