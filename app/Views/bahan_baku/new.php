                ...
                <div class="card-body col-md-5">
                    <form action="<?=site_url('bahan_baku')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_bahan_baku" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <!-- <div class="form-group">
                            <label for="gambar_bahan_baku">Gambar*</label>
                            <input type="file" name="gambar_bahan_baku" id="gambar_bahan_baku" class="form-control">
                        </div> -->
                        <br>
                        <div>
